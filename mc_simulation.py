#!/usr/bin/env python3
"""
SAPM Monte Carlo Simulation — Arms Exports / End-Use Enforcement Impossibility
================================================

Reproduces all quantitative results in:

  Postnieks, E. (2026). SAPM Working Paper: Arms Exports (End-Use Enforcement Impossibility).
  Available: SSRN.
...
CONFIG = {
    "paper_id": "arms_exports",
    "domain_name": "Arms Exports",
    "theorem": "End-Use Enforcement Impossibility",
    "classification": "Class 1 \u2014 Impossibility",
    "seed": 42,
    "n_draws": 100000,
    "correlation_rho": 0.3,
    "private_payoff_B": 29.6,
    "channels": {
        "C1_conflict_casualties": {
            ...
            "high": 48.8,
            "weight": 0.35,
            "description": "100K+ conflict deaths/yr enabled by weapons. Sources: SIPRI, UCDP, UNHCR."
        },
        "C2_humanitarian_crisis": {
            ...
            "high": 22.2,
            "weight": 0.25,
            "description": "Refugee flows, famine, infrastructure destruction. Sources: UNHCR, OCHA, MSF."
        },
        "C3_arms_race_dynamics": {
            ...
            "high": 24.4,
            "weight": 0.2,
            "description": "Regional arms races, proliferation. Sources: SIPRI, IISS Military Balance."
        },
        "C4_development_diversion": {
            ...
            "high": 12.2,
            "weight": 0.1,
            "description": "Military spending crowds out health/education. Sources: World Bank, SIPRI."
        },
        "C5_end_use_enforcement_failure": {
            ...
            "high": 6.1,
            "weight": 0.1,
            "description": "Diversion, re-transfer, monitoring failure. Sources: ATT, Conflict Armament Research."
        }
    },
    "impossibility_floor": 1.4
}
